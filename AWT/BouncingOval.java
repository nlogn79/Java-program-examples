...
public class BouncingOval {
	...
	/**
	 * Initialize a new oval with its center located at (startX, startY), filled
	 * with startColor.
	 */
	...
	public void draw(Graphics surface) {
		...
		surface.fillOval(x - SIZE / 2, y - SIZE / 2, SIZE, SIZE + 5);
		surface.setColor(Color.BLACK);
		((Graphics2D) surface).setStroke(new BasicStroke(3.0f));
		surface.drawOval(x - SIZE / 2, y - SIZE / 2, SIZE, SIZE + 5);
